...
export default defineSchema({
  ...
  businesses: defineTable({
    ...
    treatment: v.string(),
    source: v.union(v.literal("demo_fixture"), v.literal("firecrawl")),
  ...
  approvals: defineTable({
    ...
    inquiry: v.optional(
      v.object({
        ...
        subject: v.string(),
        body: v.string(),
        testRecipient: v.boolean(),
        sendEnabled: v.boolean(),
      }),
    ),
    currency: v.literal("SGD"),
  ...
  outcomes: defineTable({
    ownerKey: v.string(),
    taskId: v.id("tasks"),
    status: v.union(v.literal("scheduled"), v.literal("inquiry_sent")),
    message: v.string(),
    createdAt: v.number(),
  }).index("by_taskId", ["taskId"]),
